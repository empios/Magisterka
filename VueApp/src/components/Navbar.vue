  ...
  <div>
    <Navbar>
      ...
      <template #default="{ isShowMenu }">
        ...
        <div class="xl:flex w-full xl:w-auto" v-show="!props.isLoggedOut">
          <p class="text-center mt-3 xl:mt-2 xl:ml-0 xl:mr-3 text-gray-700" v-text="email" />
          <div class="flex justify-center">
            <button
              type="button"
              @click="logout"
              class="mt-2 lg:ml-0 lg:mt-0 text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Logout
            </button>
          </div>
